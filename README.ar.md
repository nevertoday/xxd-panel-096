<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 096" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 096｜بطاقة المراسلات الشعبية

### يحوّل الصورة إلى بطاقة QSL تبدو مطبوعة ومُرسلة يدويًا
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 096 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

القالب التجاري القديم يمحو عفوية الطباعة الخاصة؛ يعيد 096 بناء الصورة كقطعة إبيميرا ملموسة على بطاقة QSL.

يحفظ **Panel 096** الهوية بخطوط حبر رفيعة وتهشير محدود، ويمزج معها حروف آلة كاتبة ضيقة وصغيرة ومتآكلة ومنزاحة. لون ورق واحد وحبر طباعة واحد متباين يمنحان النتيجة مباشرة وحرفية وواثقة بصريًا.

### مناسب لـ

- بطاقات QSL، تأكيدات الراديو، الإعلانات الخاصة، ومطبوعات المنشورات السرية؛
- مزج حر ومنظم بين الرسم الخطي والعلامات التقنية والنص المطبوع والفراغ غير المنتظم؛
- حبيبات النسخ وتفاوت الحبر وألياف الورق وتآكل الحروف وانحراف التسجيل؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 096 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** بطاقة QSL · إبيميرا شعبية · آلة كاتبة · رسم بالحبر · ورق ملوّن + حبر واحد · حبيبات DIY
...
|---|---|
| **الناتج** | بطاقة اتصال تبدو مطبوعة ومُستنسخة ومُرسلة من شخص خاص |
| **البصمة الواضحة** | ورق بلون واحد، حبر واحد، خطوط قلم دقيقة، كتابة آلة كاتبة بالية، وحبيبات نسخ DIY |
...
```text
تحليل الموضوع والوضع والعلاقة السردية → اختيار لون ورق واحد من الصورة → رسم البنى المهمة بحبر واحد وخطوط قلم رفيعة → مزج عناوين وأرقام ومعلومات اتصال ذات معنى بآلة كاتبة → إبقاء حبيبات النسخ وتآكل الحروف وألياف الورق وانحراف التسجيل
```

## سمات النتيجة النهائية

- حافظ على ورق ملوّن واحد وحبر طباعة واحد، ولا توسع النتيجة إلى لوحة غنية.
- استخدم محيطات قلم رفيعة ومتقطعة وتهشيرًا محدودًا بدل الظلال الواقعية.
- اجعل حروف الآلة الكاتبة الصغيرة والميكانيكية والمتآكلة جزءًا من البطاقة.
- ابنِ الإيقاع من الفراغ غير المنتظم والمحاذاة المنزاحة والهوامش الضيقة والكثافة الموضعية.
- تجنّب القوالب التجارية والتدرجات و3D والمتجهات الملساء والنصوص الوهمية.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-096-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 096. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-096 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-096 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-096 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-096 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-096 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 096 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-096 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-096`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-096-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-096-prompt.zh-CN.md)
...
| **[xxd-panel-096](https://github.com/nevertoday/xxd-panel-096)** | بطاقة QSL · آلة كاتبة · ورق ملوّن + حبر واحد · رسم بالحبر · حبيبات نسخ DIY |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–096) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
