...
```text
/xxd-panel-096 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，096 设计在下）
2. 左右对照（原图在左，096 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-096/<fresh-task>/
...
- `references/xxd-panel-096-prompt.zh-CN.md`
- `references/xxd-panel-096-prompt.en.md`
