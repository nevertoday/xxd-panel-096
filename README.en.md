<p align="center"><img src="./assets/banner.svg" alt="XXD Panel 096 project banner" width="1200"></p>
...
Sample positions are reserved. Verifiable original works or extensions reviewed directly against the Panel 096 source brief will be shown here first; images from another numbered Panel and broken placeholders are never substituted.
...
| **[xxd-panel-096](https://github.com/nevertoday/xxd-panel-096)** | QSL CARD · VERNACULAR EPHEMERA · TYPEWRITER · COLOURED PAPER + ONE INK · DIY COPY GRAIN |
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–096) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
